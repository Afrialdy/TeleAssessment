                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Kemampuan menangkap inti atau makna dari sesuatu yang disampaikan melalui bahasa,
                                        ...
                                        judgement,mandiri dalam berfikir, pembentukan keputusan. Yang dimaksud dengan
                                        “judgement,”
                                        adalah artinya apakah testee mampu menilai arti apakah ia mandiri, atau apakah ia
                                        salah
                                        kaprah
                                    </td>
                                    <td>{{ $penilaianBeo->cognitive_video_score }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>Kemampuan fleksibilitas dalam berpikir, kemampuan mengkombinasikan atau
                                        ...
                                        untuk
                                        melawan
                                        solusi masalah yang tidak pasti sehingga meliputi kejelasan dan kekonsenkuenan dalam
                                        berpikir
                                    </td>
                                    <td>{{ $penilaianBeo->cognitive_video_score }}</td>
                                    <td class="center-align"></td>
                                ...
                                <tr>
                                    ...
                                    <td>Kemampuan abstraksi verbal, menemukan ciri yang sama atau khas dari dua objek dan
                                        ...
                                        bentuk
                                        Bahasa,
                                        membentuk suatu pengertian atau mencari inti persoalan, serta memahami esensi
                                        pengertian
                                        suatu
                                ...
                                <tr>
                                    ...
                                    <td>Cara berpikir teoritis dengan hitungan. Maksudnya mengukur kemampuan berhitung
                                        ...
                                        didapatkan
                                        suatu kesimpulan (berpikir induktif dengan angkaangka), serta kelincahan dan irama
                                        dalam
                                        berpikir</td>
                                    <td>{{ $penilaianBeo->cognitive_video_score }}</td>
                                    <td class="center-align"></td>
