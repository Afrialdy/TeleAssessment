...
<body>
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li>View Validation Test Kognitif Rendah</li>
        </ul>
        <div class="d-flex justify-content-center">
            <ol id="question-list">
                <div class="question">
                    <li>
                        <p class="pertanyaan">Dalam perkembangan teknologi informasi, konektivitas yang .........
                            memungkinkan berbagi data dan informasi dengan cepat di seluruh dunia.</p>
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Pemahaman ........ teori psikologi membantu dalam mengidentifikasi pola
                            perilaku manusia dalam berbagai konteks.</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Dalam bidang ekonomi, konsep inflasi mengacu pada....... umumnya naiknya
                            harga-harga barang dan jasa dalam suatu periode waktu.</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Mana dibawah ini yang paling berbeda <span
                                class="invisible-word">Mudah1</span></p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2"
                                ...
                                <label class="radio-label">
                                    <input type="radio" class="radio-input" name="answer2"
                                        value="Option Wrong 1">
                                    Rambutan
                                </label>
                                <label class="radio-label">
                                    <input type="radio" class="radio-input" name="answer2"
                                        value="Option Wrong 2">
                                    Pepaya
                                </label>
                            </form>
                        </div>
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Mana dibawah ini yang paling berbeda <span
                                class="invisible-word">Mudah2</span></p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2"
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Mana dibawah ini yang paling berbeda <span
                                class="invisible-word">Mudah3</span></p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2"
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Keras Kepala : .... =</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2"
    ...
    <div class="d-flex justify-content-center">
        ...
        {{-- <!-- <a href="{{ route('testvalidation1Susah') }}"> --> --}}
        ...
        <button class="calculate-score-button"
            style="margin-top:32px; width: 136px; height:23px; display: none;">Calculate Score</button>
    ...
    {{-- <script>
        ...
        function updateCountdown() {
            ...
            if (time < 0) {
                ...
                submitForm();
                // window.location.href = '{{ route('timesout') }}'; // Replace with your desired URL
            }
        }
    </script> --}}
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitButton.addEventListener('click', function(event) {
                ...
                const sourceBQuestions = [{
                    ...
                    {
                        Question: 'Body Image merupakan imajinasi subyektif yang dimi…hnya harus disesuaikan dengan persepsi - persepsi',
                        Score: -1
                    },
                    {
                        Question: 'Sistem patriarki yang ... perempuan dan lelaki tid…nkan terjadi oleh sebagian besar warga masyarakat',
                        Score: -1
                    },
                    {
                        Question: 'Husein Mutahar: WR Soepratman: Ismail Marzuki= .......',
                        Score: -1
                    },
                    {
                        Question: 'Bumi: Jupiter: Saturnus = ........',
                        Score: -1
                    },
                    {
                        Question: 'Kertas : Karet : Resin = .......',
                        Score: -1
                    },
                    {
