...
<head>
    ...
    <style>
        ...
        .submit-button[disabled] {
            ...
            /* Change the background color to a muted gray */
            cursor: not-allowed;
            /* Change the cursor to indicate it's not clickable */
            color: #999;
            /* Change the text color to a muted gray */
            box-shadow: none;
            /* Remove the shadow when disabled */
        }
        ...
        .submit-button[disabled]:hover::after {
            content: "Please finish all questions";
            /* Tooltip text */
            display: block;
            position: absolute;
...
<body>
    <div class="container">
        <h1 class="d-flex justify-content-between" style="padding-top: 46px; padding-bottom: 54px;">
            <span style="opacity: 0; width: 148px;"></span>
            <span class="judulTest">Tes Kognitif</span>
        ...
        <ul class="breadcrumb">
            ...
            <li>View Validation Test Kognitif Tinggi</li>
        </ul>
        <div class="d-flex justify-content-center">
            <ol id="question-list">
                <div class="question">
                    <li>
                        <p class="pertanyaan">Narsisisme juga dapat diartikan sebagai bentuk dari ... individu untuk
                            menunjukkan bahwa dirinya merupakan orang yang sempurna, pandai dan penting dibanding orang
                            lainnya agar memperoleh perhatian dan pemujaan atas dirinya.</p>
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Body Image merupakan imajinasi subyektif yang dimiliki seseorang tentang
                            tubuhnya, khususnya yang terkait dengan ... orang lain, dan seberapa baik tubuhnya harus
                            disesuaikan dengan persepsi - persepsi</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Sistem patriarki yang ... perempuan dan lelaki tidak dalam posisi sejajar
                            dapat menimbulkan masalah sosial, yakni suatu kondisi yang tidak diinginkan terjadi oleh
                            sebagian besar warga masyarakat</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Husein Mutahar: WR Soepratman: Ismail Marzuki= .......</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Bumi: Jupiter: Saturnus = ........</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Kertas : Karet : Resin = .......</p>
                        <div class="answer-form">
                            <form class="answer-form">
                                <label class="radio-label" data-correct="true">
                                    <input type="radio" class="radio-input" name="answer2" value="Option Correct">
                ...
                <div class="question">
                    <li>
                        <p class="pertanyaan">Pilihlah pola yang tepat pada soal di bawah ini:<br>
                            A, C, E, G, ...
                        </p>
                        <div class="answer-form">
                            <form class="answer-form">
        ...
        <div class="d-flex justify-content-center">
            <div id="overlay">Sedang Diproses...<br> Dimohon untuk tidak merefresh atau menutup halaman.</div>
            ...
            <button id="submit-button" class="submit-button" disabled
                title="Please finish all questions">Submit</button>
            <!-- <a> -->
            <br>
            ...
            <button class="calculate-score-button" style="margin-top:32px; display: none;">Calculate Score</button>
            {{-- <form method="get" action="{{ route('logout') }}">
           @csrf <!-- Include a CSRF token for security -->
           <button type="submit">Logout</button>
       </form> --}}
            <button id="processVideoButton" onclick="calculateAndLogSkor()" style="display: none;">See Current Total
                Score</button>
        </div>
</body>
...
<script>
    ...
    function navigateToQuestion(desiredQuestionNumber) {
        if (!isNaN(desiredQuestionNumber) && desiredQuestionNumber >= 1 && desiredQuestionNumber <= questionsArray
            .length) {
            // Hide the current question
            questionsArray[currentQuestionIndex].style.display = 'none';
...
<script>
    const questionData = [{
            Question: 'Dalam perkembangan teknologi informasi, konektivit…data dan informasi dengan cepat di seluruh dunia.',
            Score: -1
        },
        {
            Question: 'Pemahaman ........ teori psikologi membantu dalam …asi pola perilaku manusia dalam berbagai konteks.',
            Score: -1
        },
        {
            Question: 'Dalam bidang ekonomi, konsep inflasi mengacu pada.…-harga barang dan jasa dalam suatu periode waktu.',
            Score: -1
        },
        {
            Question: 'Mana dibawah ini yang paling berbeda Mudah1',
            Score: -1
        },
        {
            Question: 'Mana dibawah ini yang paling berbeda Mudah2',
            Score: -1
        },
        {
            Question: 'Mana dibawah ini yang paling berbeda Mudah3',
            Score: -1
        },
        {
            Question: 'Sejalan : .... =',
    ...
    document.querySelectorAll('.question').forEach(questionElement => {
        ...
        const score = radioInput ? (radioInput.parentElement.getAttribute('data-correct') === 'true' ? 1 : 0) :
            0;
